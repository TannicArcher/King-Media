...
if ($permiterror || qa_opt( 'disable_music' )) {
    ...
    $qa_content['custom'] = '<div class="nopost"><i class="far fa-frown-open fa-4x"></i> '.qa_lang_html('misc/no_permission').'</div>';
    return $qa_content;
}
...
if (qa_clicked('doask')) {
    ...
    if (!qa_check_form_security_code('ask', qa_post_text('code'))) {
        ...
        if (empty($errors)) {
            ...
            if ($type == "dailymotion.com" || $type == "metacafe.com" || $type == "vine.co" || $type == "instagram.com" || $type == "vid.me" || $type == "drive.google.com" || $type == "open.spotify.com" || $type == "twitter.com") {
            ...
            if ( isset( $_POST['out'] ) ) {
                ...
                qa_db_query_sub('INSERT INTO ^poll (postid, content, created, type) VALUES (#, $, NOW(), $)', $questionid, $poll, 'music' );
...
$qa_content['title'] = qa_lang_html('misc/king_music');
...
if (qa_opt('enable_music_upload')) {
    $vidupload .= '<div class="tabcontent musica" role="tabpanel" id="vidup">';
    ...
    $vidupload .= '</div>';
    $vidupload .= '<div class="king-ang" ng-model="inputs">
